...
if __name__== "__main__":
    ...
    conv1 = nn.Conv2d(in_channels=3, out_channels=64, kernel_size=3, stride=2, padding=1)
    out1 = conv1(my_tensor)
    print("===== problem1 =====")
    print(repr(out1.size()))

    conv1 = nn.Conv2d(in_channels=3, out_channels=256, kernel_size=5, stride=2, padding=1)
    out1 = conv1(my_tensor)
    print("===== problem2 =====")
    print(repr(out1.size()))